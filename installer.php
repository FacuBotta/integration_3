...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230208_integration3_botta_8f477db7c96cd5364093_20230208103003_archive.zip';
        const ARCHIVE_SIZE       = '53092494';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '8f477db-08103003';
        const SECONDARY_PACKAGE_HASH = 'ad8b1b7-08103003';
